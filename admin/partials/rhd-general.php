...
<?php
global $rhd_admin;
echo $rhd_admin->page_tabs('rhd-migration');
...
<div class="rhd-grid rhd-top-margin">
  <div class="rhd-col-8-12 rhd-segment">  
  <div class="rhd-section rhd-group">
  <div class="rhd-col rhd_span_1_of_2">
      <form method='post' action='options.php' name="rhd_general_form" id="rhd_general_form">
                ...
                <table class='form-table'>   
                     <tr valign='top'>
                        <th scope='row'><?php echo esc_html_e( 'Website', 'rhd-migration' ); ?></th>
                        <td>
                            <select name="rhd_website" id="rhd_website" size="1" required >
                                <?php
                              ...
                              <div class="rhd-help-text"><?php echo esc_html_e( 'Select the source or destination operation that wants to migrate data', 'rhd-migration' ); ?></div>
                        </td>
                    </tr>
                    ...
                    <tr valign='top'  class=" rhd_destination_section" >
                        <th scope='row'><?php echo esc_html_e( 'Default Author' , 'rhd-migration'); ?></th>
                        <td>
                            <select name="rhd_author" size="1"  id="rhd_author" >
                                <?php
                              ...
                              <div class="rhd-help-text"><?php echo esc_html_e( "Default author get assigned for post, page etc..", 'rhd-migration' ); ?></div>
                        </td>
                    </tr>
                    <tr valign='top'  class=" rhd_destination_section" >
                        <th scope='row'><?php echo esc_html_e( 'Media Exclude' , 'rhd-migration'); ?></th>
                        <td>
                            <select name="rhd_media_exclude" size="1"  id="rhd_media_exclude" >
                                <?php
                              ...
                              <div class="rhd-help-text"><?php echo esc_html_e( "If you want to exclude images or pdfs etc.. during migration. Means you will manually move media on destination website.", 'rhd-migration' ); ?></div>
                        </td>
                    </tr>
                    <tr valign='top'  class=" rhd_destination_section" >
                    ...
                    <tr valign='top'  class=" rhd_source_section" >
                        <th scope='row'><?php echo esc_html_e( 'Comments' , 'rhd-migration'); ?></th>
                        <td>
                            <select name="rhd_comment" size="1"  id="rhd_comment" >
                                <?php
                                if ( is_array( $rhd_medias ) && count( $rhd_medias ) > 0 ) {
                                  foreach ( $rhd_medias as $rhd_media => $label ) {
                                    ?>
                              ...
                              <div class="rhd-help-text"><?php echo esc_html_e( 'If you want to migrate comments with post/page, select "Yes" otherwise "No".', 'rhd-migration' ); ?></div>
                        </td>
                    </tr>
                    <tr valign='top'  class=" rhd_destination_section" >
                        <th scope='row'><?php echo esc_html_e( 'Operation' , 'rhd-migration'); ?></th>
                        <td>
                            <select name="rhd_operation" size="1"   id="rhd_operation" >
                                <?php
                              ...
                              <div class="rhd-help-text"><?php echo esc_html_e( "Add/Update: If it's not exist then it create and update if exists.", 'rhd-migration' ); ?></div>
                              <div class="rhd-help-text"><?php echo esc_html_e( "Add: If it's not exist then it'll create else ignore it.", 'rhd-migration' ); ?></div>
                              <div class="rhd-help-text"><?php echo esc_html_e( "Update: If it exists then update else ignore it.", 'rhd-migration' ); ?></div>
                        </td>
                    </tr>
                </table>
                <?php submit_button(); ?>
